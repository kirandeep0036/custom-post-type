	...
	class Gust_Post{
		...
		public function guest_post_admin_menu() {
			add_menu_page(
				...
				'manage_options',
				'guest_post_setting',
				array($this, 'guest_post_contents'), //callback function setting page
				'dashicons-schedule',
				2
			);
		}
		...
		public function guest_post_contents() {
				...
				$html .= "<tr><td><b>Shortcode to show all pending posts</b></td><td>[list_of_posts]</td></tr>";
		...
		public function create_new_post() {
			...
			if(isset($_POST['action'])){
				...
				if($post_id){
					...
					$this->add_featured_img($_FILES['file'], $post_id);
